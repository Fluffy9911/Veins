...
public enum VeinType {
	COPPER(new BlockState[] { Blocks.COPPER_ORE.defaultBlockState(), Blocks.DEEPSLATE_COPPER_ORE.defaultBlockState() },
			...
			new BlockState[] { Blocks.STONE.defaultBlockState(), Blocks.DEEPSLATE.defaultBlockState() }, 0, 50),
	...
	COAL(new BlockState[] { Blocks.COAL_ORE.defaultBlockState(), Blocks.DEEPSLATE_COAL_ORE.defaultBlockState() },
			...
			new BlockState[] { Blocks.STONE.defaultBlockState(), Blocks.DEEPSLATE.defaultBlockState() }, 0, 128),
	...
	LAPIS(new BlockState[] { Blocks.LAPIS_ORE.defaultBlockState(), Blocks.DEEPSLATE_LAPIS_ORE.defaultBlockState() },
			...
			new BlockState[] { Blocks.STONE.defaultBlockState(), Blocks.DEEPSLATE.defaultBlockState() }, 0, 30),
	...
	REDSTONE(
			...
			new BlockState[] { Blocks.STONE.defaultBlockState(), Blocks.DEEPSLATE.defaultBlockState() }, 0, 16),
